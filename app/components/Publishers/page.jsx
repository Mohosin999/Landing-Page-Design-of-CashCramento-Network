      ...
      <div className="py-14 lg:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 lg:mx-28 mt-12 lg:mt-16">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="mt-3 lg:mt-5 text-sm">Exclusive offers available</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="mt-3 lg:mt-5 text-sm">Weekly payouts</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="mt-3 lg:mt-5 text-sm">Multi-geographical regions</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="mt-3 lg:mt-5 text-sm">Delicated program</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="mt-3 lg:mt-5 text-sm">Inventive materials</p>
          </div>
        </div>
      </div>
    </Layout>
