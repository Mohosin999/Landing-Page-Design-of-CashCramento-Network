          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              ...
              <div className="mb-10 lg:mb-12">
                <h1 className="text-gray-900 dark:text-gray-200 text-xl md:text-3xl xl:text-5xl font-bold mb-2 lg:mb-3 uppercase space-x-24 mx-6 md:mx-12 lg:mx-40 drop-shadow-2xl">
                  Marketing is Targeting minds,
                </h1>

                <h1 className="text-gray-900 dark:text-gray-200 text-xl md:text-3xl xl:text-5xl font-bold uppercase space-x-24 mx-6 md:mx-12 lg:mx-40">
                  hitting wallets, embodying{" "}
                  <span className="text-sky-600 inline-block animate-bounce mt-2 lg:mt-3">
                    CashCramento
                  </span>
                </h1>
              </div>
              ...
              <div className="space-x-4">
                ...
                <Link
                  ...
                  className="bg-sky-500 text-gray-900 text-sm lg:text-base px-6 lg:px-12 py-2 lg:py-3 hover:bg-sky-700 hover:text-gray-200 rounded-md font-semibold uppercase active:bg-red-500 active:text-white duration-100 border border-sky-500"
                >
                  Sing Up
                </Link>
                ...
                <Link
                  ...
                  className="bg-white text-black text-sm lg:text-base px-6 lg:px-12 py-2 lg:py-3 hover:bg-gray-400 rounded-md font-semibold uppercase active:bg-red-500 active:text-white duration-100 border border-gray-900 hover:border-gray-400"
                >
                  Login
                </Link>
              </div>
